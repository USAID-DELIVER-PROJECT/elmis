...
public class FacilityReferenceData {
  ...
  public static  final String FACILITY_OWNERS="facilityOwners";
  ...
  public FacilityReferenceData addFacilityOwners(List<FacilityOwner> facilityOwners) {
    referenceData.put(FACILITY_OWNERS, facilityOwners);
    return this;
  }
}
