function ViewIssueVoucherController($scope,homeFacility,programs,DistributionByVoucherNumber,
                                    GetAllOneLevelFacilities,$window,GetDistributionsByDateRangeAndFacility,
                                    messageService,FacilityTypeAndProgramProducts,VaccineProgramProducts){
    ...
    $scope.loadRequisitions = function(){
        ...
        GetDistributionsByDateRangeAndFacility.get({facilityId:$scope.selectedFacilityId,
    ...
    GetAllOneLevelFacilities.get({}, function(data){
...
ViewIssueVoucherController.resolve = {
