CREATE OR REPLACE FUNCTION fn_get_vaccine_coverage_denominator(in_program integer, in_facility integer, in_year integer, in_product integer, in_dose integer)
  RETURNS integer AS
$BODY$
DECLARE
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION fn_get_vaccine_coverage_denominator(integer, integer, integer, integer, integer)
  OWNER TO postgres;
