...
BEGIN
BEGIN
ALTER TABLE equipment_cold_chain_equipment_designations DROP COLUMN IF EXISTS "hasEnergy" RESTRICT;
ALTER TABLE equipment_cold_chain_equipment_designations DROP COLUMN IF EXISTS hasEnergy RESTRICT;
...
END;
BEGIN
ALTER TABLE equipment_cold_chain_equipment_designations DROP COLUMN IF EXISTS "isRefrigerator" RESTRICT;
ALTER TABLE equipment_cold_chain_equipment_designations
...
END;
BEGIN
ALTER TABLE equipment_cold_chain_equipment_designations DROP COLUMN IF EXISTS "isFreezer" RESTRICT;
...
END;
BEGIN
ALTER TABLE equipment_cold_chain_equipment_designations DROP COLUMN IF EXISTS "capacity" RESTRICT;

ALTER TABLE equipment_cold_chain_equipments ADD COLUMN capacity numeric(8,2);
 EXCEPTION
