-- Function: fn_e2e_pipeline(integer, integer, integer)

DROP FUNCTION IF EXISTS fn_e2e_pipeline(integer, integer, integer);

CREATE OR REPLACE FUNCTION fn_e2e_pipeline(IN in_program integer, IN in_year integer, IN in_period integer)
