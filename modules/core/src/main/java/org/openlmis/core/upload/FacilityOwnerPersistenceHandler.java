 ...
 */
@Component
public class FacilityOwnerPersistenceHandler extends AbstractModelPersistenceHandler {

  @Autowired
  private FacilityOwnerService service;
  ...
  protected BaseModel getExisting(BaseModel record) {
    return service.getFacilityOwner((FacilityOwner) record);
  }

  @Override
  protected void save(BaseModel record) {
    service.uploadFacilityOwner((FacilityOwner) record);
  }
