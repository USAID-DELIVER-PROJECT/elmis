...
import org.openlmis.report.mapper.OrderFillRateReportSummaryMapper;
...
@Component
@NoArgsConstructor
public class OrderFillRateReportSummaryDataProvider extends ReportDataProvider {
    @Autowired
    private OrderFillRateReportSummaryMapper mapper;
    @Autowired
