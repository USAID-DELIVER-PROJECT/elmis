...
import org.openlmis.ivdform.repository.mapper.reports.ColdChainMapper;
...
public class ColdChainLineItemRepositoryTest {

  @Mock
  ColdChainMapper mapper;

  @InjectMocks
  ColdChainLineItemRepository repository;
