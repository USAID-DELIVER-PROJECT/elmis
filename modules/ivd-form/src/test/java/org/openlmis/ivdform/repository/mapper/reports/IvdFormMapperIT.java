...
import org.openlmis.ivdform.builders.reports.DiseaseLineItemBuilder;
...
public class IvdFormMapperIT {

  @Autowired
  private IvdFormMapper ivdFormMapper;
  ...
  @Autowired
  private DiseaseLineItemMapper diseaseLineItemMapper;
  ...
  public void shouldGetById() throws Exception {
    ...
    VaccineReport newReport = ivdFormMapper.getById(report.getId());
  ...
  public void shouldGetNullWhenPeriodDoesNotMatchByPeriodFacilityProgram() throws Exception {
    ...
    VaccineReport returnedReport = ivdFormMapper.getByPeriodFacilityProgram(facility.getId(), processingPeriod.getId() + 1, 1L);
  ...
  public void shouldGetByIdWithFullDiseaseLineItemDetails() throws Exception {
    ...
    VaccineReport returnedReport = ivdFormMapper.getByIdWithFullDetails(report.getId());
  ...
  public void shouldSaveImmunizationSessions() throws Exception {
    ...
    VaccineReport returnedReport = ivdFormMapper.getById(report.getId());
  ...
  public void shouldFindPreviousReportById() throws Exception {
    Long id = ivdFormMapper.findPreviousReport(1L, 1L, 1L);
  }
}