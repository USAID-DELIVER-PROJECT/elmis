...
import org.openlmis.ivdform.repository.mapper.reports.AdverseEffectMapper;
...
public class AdverseEffectLineItemRepositoryTest {

  @Mock
  AdverseEffectMapper mapper;

  @InjectMocks
  AdverseEffectLineItemRepository repository;
