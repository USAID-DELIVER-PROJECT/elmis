...
public interface VaccineReportCoverageMapper {
  ...
  @Results(value = {
      ...
      @Result(property = "product", javaType = Product.class, column = "productId",
          many = @Many(select = "org.openlmis.ivdform.repository.mapper.reports.VaccineReportCoverageMapper.getProductDetails")),
  })
  ...
  @Results(value = {
      ...
      @Result(property = "product", javaType = Product.class, column = "productId",
          many = @Many(select = "org.openlmis.ivdform.repository.mapper.reports.VaccineReportCoverageMapper.getProductDetails")),
      @Result(property = "vaccineProductDose", column = "id", one = @One(select = "org.openlmis.ivdform.repository.mapper.reports.VaccineReportCoverageMapper.getVaccineDoseDetail"))
  })
